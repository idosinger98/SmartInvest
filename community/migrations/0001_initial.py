    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'title',
                    models.CharField(default=models.BigAutoField(primary_key=True, serialize=False), max_length=50)
                ),
                ('time', models.DateTimeField(default=django.utils.timezone.now)),
                (
                    'analysis_id',
                    models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='stockAnalysis.analyzedstock')
                ),
